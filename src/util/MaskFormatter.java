...
public class MaskFormatter {
	...
	/**
	 * Mascara de telefone com 8 e 9 digitos consecutivamente.
	 * ex: 8 Dig: (61) 9340-6012. 9 Dig: (61) 99340-6012.
	 */
	public static final int TEL_DIG = 0;
	/**
	 * Máscara de telefone com 8 digitos. ex: (61) 9340-6012.
	 * @deprecated - Utilize o TEL_DIG.
	 */
	public static final int TEL_8DIG = 1;

	/**
	 * Máscara de telefone com 9 digitos. Ex: (61) 99340-6012.
	 * @deprecated - Utilize o TEL_DIG.
	 */
	public static final int TEL_9DIG = 2;
	/**
	 ...
	 * @deprecated - Utilize o maskTelDig.
	 */
	private void maskTel8Dig() {
		...
		textField.setOnKeyTyped((KeyEvent evento) -> {
			...
			if (!"0123456789".contains(evento.getCharacter())) {
				/*
				 * usando o método consume,e como se o que o usuario digitou não
				 * tivesse efeito, ex ele digitou uma letra, mas essa letra não
				 * apareçe pq bloqueamos o evento que faz ela aperecer na tela.
				 */
				evento.consume();
			}
			/*
			 * verificamos se o caracter foi digitado ou apagado se caso apagado
			 * ele é igual a zero.
			 */
			if (evento.getCharacter().trim().length() == 0) {
				...
				case 9:
					/*
					 * subString so retornar os caracteres entre aquelas
					 * posições fazemos isso para apagar o caractere - que
					 * colocamos na mascara.
					 */
				 ...
				 * lembrando que estamos contando todos os caracteres que estão
				 * visiveis
				 */
			...
			case 1:
				/*
				 * Adicionamos o parentese no primeiro caracter.Obs: lembrando
				 * que cada caractere digitado e como se estivesse em um array
				 * então o primeiro caracter fica na posição 0
				 */
				textField.setText("(" + textField.getText());
				/*
				 * movemos sempre a letra para o ultimo lugar, sem isso a letra
				 * voltaria para o primeiro
				 */
				textField.positionCaret(textField.getText().length());
				break;
			case 3:
				/*
				 * como adicionamos um caractere parentese, aumenta mais um,
				 * então o segundo numero digitado é o 3
				 */
				textField.setText(textField.getText() + ") ");
				textField.positionCaret(textField.getText().length());
				break;
    ...
    /**
     * Método que inicia a mascara com 9 digitos.
     * @deprecated - Utilize o maskTelDig.
     */
	...
	/**
	 * Nova mascará que aceita numeros com 8 e 9 digitos consecutivamente.
	 */
	private void maskTelDig() {
